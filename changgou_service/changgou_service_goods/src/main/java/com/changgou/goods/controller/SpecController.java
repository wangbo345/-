...
public class SpecController {
    ...
    @GetMapping("/findSpecByCateName/{cateName}")
    public Result findSpecByCateName(@PathVariable String cateName){
        List<Spec> specByCateName = specService.findSpecByCateName(cateName);
        return new Result(true,StatusCode.OK,"根据分类查询规格信息成功",specByCateName);
    }
