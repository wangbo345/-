...
public class AdminServiceImpl implements AdminService {
    ...
    public boolean login(Admin admin) {
        ...
        String admin2Password = admin2.getPassword();//数据库中查询到的加密密码
        String adminPassword = admin.getPassword();//用户登录用的明文密码
        boolean checkpw = BCrypt.checkpw(adminPassword, admin2Password);
        return checkpw;
    }
